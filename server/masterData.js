...
const MASTER_DATA_CONFIG = {
  'quote-items': {
    ...
    defaults: [
      { id: 'SQI-001', itemType: 'product', name: 'Roofing Sheet', unit: 'm', defaultUnitPriceNgn: 0, active: true, sortOrder: 1 },
      { id: 'SQI-002', itemType: 'product', name: 'Bargeboard', unit: 'm', defaultUnitPriceNgn: 0, active: true, sortOrder: 2 },
      { id: 'SQI-003', itemType: 'product', name: 'Top End', unit: 'm', defaultUnitPriceNgn: 0, active: true, sortOrder: 3 },
      { id: 'SQI-004', itemType: 'product', name: 'Gutter', unit: 'm', defaultUnitPriceNgn: 0, active: true, sortOrder: 4 },
      { id: 'SQI-021', itemType: 'product', name: 'Eaves angle', unit: 'm', defaultUnitPriceNgn: 0, active: true, sortOrder: 5 },
      { id: 'SQI-022', itemType: 'product', name: 'Wall Flashing', unit: 'm', defaultUnitPriceNgn: 0, active: true, sortOrder: 6 },
      { id: 'SQI-023', itemType: 'product', name: 'Ridge Cap', unit: 'm', defaultUnitPriceNgn: 0, active: true, sortOrder: 7 },
      { id: 'SQI-024', itemType: 'product', name: 'Capping', unit: 'm', defaultUnitPriceNgn: 0, active: true, sortOrder: 8 },
      { id: 'SQI-025', itemType: 'product', name: 'Bottom eaves', unit: 'm', defaultUnitPriceNgn: 0, active: true, sortOrder: 9 },
      { id: 'SQI-026', itemType: 'product', name: 'Fascia', unit: 'm', defaultUnitPriceNgn: 0, active: true, sortOrder: 10 },
      ...
      { id: 'SQI-029', itemType: 'product', name: 'Offcut', unit: 'm', defaultUnitPriceNgn: 0, active: true, sortOrder: 13 },
      { id: 'SQI-030', itemType: 'product', name: 'Wall eaves', unit: 'm', defaultUnitPriceNgn: 0, active: true, sortOrder: 14 },
      { id: 'SQI-031', itemType: 'product', name: 'Crimp', unit: 'm', defaultUnitPriceNgn: 0, active: true, sortOrder: 15 },
      { id: 'SQI-032', itemType: 'product', name: 'Coil', unit: 'kg', defaultUnitPriceNgn: 0, active: true, sortOrder: 16 },
      {
        id: 'SQI-005',
        itemType: 'accessory',
        name: 'Tapping Screw',
      ...
      },
      {
        ...
        active: true,
        sortOrder: 104,
        inventoryProductId: 'ACC-FLASH-BAND-ROLL',
      },
      {
        id: 'SQI-012',
        itemType: 'accessory',
      ...
      },
      {
        ...
        active: true,
        sortOrder: 108,
        inventoryProductId: 'ACC-FELT-ROLL',
      },
      {
        id: 'SQI-016',
        itemType: 'accessory',
        name: 'Hooks and bolts',
        unit: 'pcs',
        defaultUnitPriceNgn: 0,
        active: true,
        sortOrder: 109,
        inventoryProductId: 'ACC-HOOKS-BOLT-PCS',
      },
      {
        id: 'SQI-017',
        itemType: 'accessory',
        ...
        active: true,
        sortOrder: 110,
        inventoryProductId: 'ACC-WASHER-PACK',
      },
      {
        id: 'SQI-018',
        itemType: 'accessory',
        ...
        active: true,
        sortOrder: 111,
        inventoryProductId: 'ACC-REPAIR-KIT',
      },
      {
        id: 'SQI-019',
        itemType: 'accessory',
        ...
        active: true,
        sortOrder: 112,
        inventoryProductId: 'ACC-STRAPPING-NAIL-PACK',
      },
      {
        id: 'SQI-020',
        itemType: 'accessory',
        ...
        active: true,
        sortOrder: 113,
        inventoryProductId: 'ACC-SPOOL-PACK',
      },
      {
        id: 'SQI-035',
        itemType: 'accessory',
        ...
        active: true,
        sortOrder: 114,
        inventoryProductId: 'ACC-STONE-NAIL-PACK',
      },
      { id: 'SQI-009', itemType: 'service', name: 'Commission', unit: 'job', defaultUnitPriceNgn: 0, active: true, sortOrder: 201 },
      { id: 'SQI-010', itemType: 'service', name: 'Transportation', unit: 'job', defaultUnitPriceNgn: 0, active: true, sortOrder: 202 },
      { id: 'SQI-011', itemType: 'service', name: 'Installation', unit: 'job', defaultUnitPriceNgn: 0, active: true, sortOrder: 203 },
      { id: 'SQI-033', itemType: 'service', name: 'Corrugation', unit: 'job', defaultUnitPriceNgn: 0, active: true, sortOrder: 204 },
      { id: 'SQI-034', itemType: 'service', name: 'Bending', unit: 'job', defaultUnitPriceNgn: 0, active: true, sortOrder: 205 },
    ],
  ...
  colours: {
    ...
    defaults: [
      { id: 'COL-001', name: 'HM Blue', abbreviation: 'HMB', active: true, sortOrder: 10 },
      { id: 'COL-002', name: 'Traffic Black', abbreviation: 'TB', active: true, sortOrder: 20 },
      { id: 'COL-003', name: 'TC Red', abbreviation: 'TR', active: true, sortOrder: 30 },
      { id: 'COL-004', name: 'Bush Green', abbreviation: 'BG', active: true, sortOrder: 40 },
      { id: 'COL-010', name: 'Gray Beige', abbreviation: 'GB', active: true, sortOrder: 50 },
      { id: 'COL-006', name: 'Ivory Beige', abbreviation: 'IV', active: true, sortOrder: 60 },
      { id: 'COL-009', name: 'P Red', abbreviation: 'PR', active: true, sortOrder: 70 },
      { id: 'COL-008', name: 'Pale Green', abbreviation: 'PG', active: true, sortOrder: 80 },
      { id: 'COL-007', name: 'Nut Brown', abbreviation: 'NB', active: true, sortOrder: 90 },
      { id: 'COL-011', name: 'Stucco', abbreviation: 'ST', active: true, sortOrder: 100 },
      { id: 'COL-012', name: 'National Green', abbreviation: 'NG', active: true, sortOrder: 110 },
      { id: 'COL-013', name: 'Cobalt Blue', abbreviation: 'CB', active: true, sortOrder: 120 },
      { id: 'COL-014', name: 'Canary Yellow', abbreviation: 'CY', active: true, sortOrder: 130 },
      { id: 'COL-015', name: 'Coloured', abbreviation: 'CL', active: true, sortOrder: 140 },
  ...
  profiles: {
    ...
    defaults: [
      { id: 'PROF-001', name: 'Longspan (Indus6)', active: true, sortOrder: 10, materialTypeId: 'MAT-002' },
      { id: 'PROF-002', name: 'Longspan (Metra)', active: true, sortOrder: 20, materialTypeId: 'MAT-002' },
      { id: 'PROF-012', name: 'Metcoppo', active: true, sortOrder: 30, materialTypeId: 'MAT-002' },
      { id: 'PROF-013', name: 'Stone coated', active: true, sortOrder: 40, materialTypeId: 'MAT-005' },
      { id: 'PROF-006', name: 'Flat sheet', active: true, sortOrder: 50, materialTypeId: 'MAT-002' },
      { id: 'PROF-014', name: 'Offcut', active: true, sortOrder: 60, materialTypeId: 'MAT-002' },
      { id: 'PROF-003', name: 'Steptile', active: true, sortOrder: 70, materialTypeId: 'MAT-002' },
      { id: 'PROF-004', name: 'Capping', active: true, sortOrder: 75, materialTypeId: 'MAT-002' },
      { id: 'PROF-005', name: 'Ridge Cap', active: true, sortOrder: 80, materialTypeId: 'MAT-002' },
  ...
  'price-list': {
    ...
    defaults: [
      ...
      },
      {
        ...
        materialTypeId: 'MAT-001',
        profileId: 'PROF-004',
        notes: 'Reference selling price for bargeboard',
        active: true,
        sortOrder: 2,
      },
      {
