...
export const HR_SELF_SERVICE_API_PATTERNS = [
  ...
  /^\/staff\/[^/]+\/loan-schedule$/,
  /^\/api\/hr\/staff\/[^/]+\/money-summary$/,
  /^\/staff\/[^/]+\/money-summary$/,
  /^\/api\/hr\/obligation-accounts$/,
  /^\/obligation-accounts$/,
  /^\/api\/hr\/obligation-accounts\/[^/]+$/,
  /^\/obligation-accounts\/[^/]+$/,
  /^\/api\/hr\/obligation-accounts\/[^/]+\/statement\.pdf$/,
  /^\/obligation-accounts\/[^/]+\/statement\.pdf$/,
  /^\/api\/hr\/obligation-accounts\/[^/]+\/disbursement-voucher\.pdf$/,
  /^\/obligation-accounts\/[^/]+\/disbursement-voucher\.pdf$/,
  /^\/api\/hr\/obligation-accounts\/[^/]+\/transactions\/[^/]+\/receipt\.pdf$/,
  /^\/obligation-accounts\/[^/]+\/transactions\/[^/]+\/receipt\.pdf$/,
  /^\/api\/hr\/id-cards(\/|$)/,
  /^\/id-cards(\/|$)/,
