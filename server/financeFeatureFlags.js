 ...
 *   apReceivedBasisEnabled: boolean,
 *   apReceivedBasisRebuildEnabled: boolean,
...
export function readFinanceFeatureFlags() {
  return {
    ...
    inventoryValuationReportsEnabled: envFlag('INVENTORY_VALUATION_REPORTS_ENABLED', true),
...
export function accountingPolicyV1HealthCapabilities(flags = readFinanceFeatureFlags()) {
  return {
    ...
    ap2SupplierDiagnostics: 'ap2a',
    ap2ReceivedBasisRebuild: 'ap2b-preview',
