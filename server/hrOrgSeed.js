...
const DESIGNATIONS = [
  des({ id: 'desig_md', code: 'MD', departmentCode: 'EXEC', title: 'Managing Director', level: 7, step: 1, grade: 'G6-G7', seniority: 'leadership', siteScope: 'HQ', notes: 'Executive + procurement owner', titleTier: 'executive', minServiceYears: 5 }),
  ...
  des({ id: 'desig_gmhr', code: 'GMHR', departmentCode: 'HR', title: 'General Manager – Human Resources', level: 6, step: 1, grade: 'G5-G6', seniority: 'leadership', siteScope: 'HQ', notes: 'Final HR approvals', titleTier: 'executive', minServiceYears: 5 }),
  ...
  des({ id: 'desig_hoa', code: 'HOA', departmentCode: 'FIN', title: 'Head Accountant', level: 5, step: 1, grade: 'G4-G5', seniority: 'leadership', siteScope: 'HQ', notes: 'Finance + procurement paperwork support', titleTier: 'manager', minServiceYears: 4 }),
  des({ id: 'desig_acct', code: 'ACCT', departmentCode: 'FIN', title: 'Accountant', level: 4, step: 1, grade: 'G3-G4', seniority: 'senior', siteScope: 'HQ', notes: 'GL, vouchers, reporting', titleTier: 'officer', minServiceYears: 2 }),
  ...
  des({ id: 'desig_adm', code: 'ADM', departmentCode: 'ADM', title: 'Admin / Office Assistant', level: 2, step: 1, grade: 'G1-G2', seniority: 'entry', siteScope: 'HQ', notes: 'Filing and front desk', titleTier: 'assistant' }),
  des({ id: 'desig_bm', code: 'BM', departmentCode: 'BRANCH', title: 'Branch Manager', level: 5, step: 1, grade: 'G4-G5', seniority: 'leadership', siteScope: 'Branch', notes: 'Full branch authority', titleTier: 'manager', minServiceYears: 5 }),
  des({ id: 'desig_abm', code: 'ABM', departmentCode: 'BRANCH', title: 'Assistant Branch Manager', level: 4, step: 1, grade: 'G3-G4', seniority: 'senior', siteScope: 'Branch', notes: 'BM backup', titleTier: 'deputy', minServiceYears: 3 }),
  ...
  des({ id: 'desig_so', code: 'SO', departmentCode: 'SALES', title: 'Sales Officer / Estimator', level: 3, step: 1, grade: 'G2-G3', seniority: 'mid', siteScope: 'Branch', notes: 'Quotations and customers', titleTier: 'officer', minServiceYears: 1 }),
  ...
  des({ id: 'desig_sk', code: 'SK', departmentCode: 'OPS', title: 'Store Keeper / Operations Officer', level: 3, step: 1, grade: 'G2-G3', seniority: 'mid', siteScope: 'Branch', notes: 'Stock and GRN', titleTier: 'officer', minServiceYears: 1 }),
  ...
  des({ id: 'desig_csh', code: 'CSH', departmentCode: 'FIN', title: 'Cashier', level: 3, step: 1, grade: 'G2-G3', seniority: 'mid', siteScope: 'Branch', notes: 'Receipts and approved payouts', titleTier: 'officer', minServiceYears: 1 }),
    ...
    ? db.prepare(
        `INSERT INTO hr_designations (id, title, department_id, grade_category, seniority_band, default_salary_level, default_salary_step,
         ...
         VALUES (@id, @title, @department_id, @grade_category, @seniority_band, @default_salary_level, @default_salary_step,
          @job_description, NULL, NULL, NULL, NULL, NULL, @salary_range_note, @min_service_years, @title_tier, @functional_office_key, @is_acting,
          1, @now, @now, NULL, NULL)
         ON CONFLICT(id) DO UPDATE SET
