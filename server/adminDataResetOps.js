...
export const ADMIN_DATA_RESET_PRESETS = [
  ...
  },
  {
    ...
    warning:
      'Deletes customers, quotations, cutting lists, production, POs, coil lots, stock movements, and customer cashbook ledger rows. Does not remove app users, catalog products, or master price lists.',
    tables: [
      'coil_control_events',
