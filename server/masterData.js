...
const MASTER_DATA_CONFIG = {
  'quote-items': {
    ...
    defaults: [
      ...
      { id: 'SQI-031', itemType: 'product', name: 'Crimp', unit: 'm', defaultUnitPriceNgn: 0, active: true, sortOrder: 18 },
      { id: 'SQI-032', itemType: 'product', name: 'Coil', unit: 'kg', defaultUnitPriceNgn: 0, active: true, sortOrder: 19 },
      {
        id: 'SQI-005',
        itemType: 'accessory',
        name: 'Tapping Screw',
